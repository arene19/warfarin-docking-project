...
MODULE OpenMM_Types
    ...
    type OpenMM_OrientationRestraintForce
        integer*8 :: handle = 0
    end type
    ...
    type OpenMM_ATMForce_CoordinateTransformation
        integer*8 :: handle = 0
    end type

    type OpenMM_ATMForce_ParticleOffsetDisplacement
        integer*8 :: handle = 0
    end type
    ...
    type OpenMM_CustomVolumeForce
        integer*8 :: handle = 0
    end type

    type OpenMM_QTBIntegrator
        integer*8 :: handle = 0
    end type
    ...
    type OpenMM_ATMForce
        integer*8 :: handle = 0
    end type

    type OpenMM_MinimizationReporter
        integer*8 :: handle = 0
    end type
    ...
    type OpenMM_ATMForce_FixedDisplacement
        integer*8 :: handle = 0
    end type
    ...
    type OpenMM_ConstantPotentialForce
        integer*8 :: handle = 0
    end type
    ...
    integer*4, parameter :: OpenMM_ConstantPotentialForce_CG = 0
    integer*4, parameter :: OpenMM_ConstantPotentialForce_Matrix = 1
...
b4)
        ...
        function OpenMM_TabulatedFunction_getUpdateCount(target)
            use OpenMM_Types; implicit none
            type (OpenMM_TabulatedFunction) target
            integer*4 OpenMM_TabulatedFunction_getUpdateCount
        end function
...
weight3)
        ...
        subroutine OpenMM_DPDIntegrator_create(result, temperature, &
defaultFriction, &
defaultCutoff, &
stepSize)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) result
            real*8 temperature
            real*8 defaultFriction
            real*8 defaultCutoff
            real*8 stepSize
        end subroutine
        subroutine OpenMM_DPDIntegrator_destroy(destroy)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) destroy
        end subroutine
        function OpenMM_DPDIntegrator_getTemperature(target)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) target
            real*8 OpenMM_DPDIntegrator_getTemperature
        end function
        subroutine OpenMM_DPDIntegrator_setTemperature(target, temp)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) target
            real*8 temp
        end subroutine
        function OpenMM_DPDIntegrator_getDefaultFriction(target)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) target
            real*8 OpenMM_DPDIntegrator_getDefaultFriction
        end function
        subroutine OpenMM_DPDIntegrator_setDefaultFriction(target, friction)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) target
            real*8 friction
        end subroutine
        function OpenMM_DPDIntegrator_getDefaultCutoff(target)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) target
            real*8 OpenMM_DPDIntegrator_getDefaultCutoff
        end function
        subroutine OpenMM_DPDIntegrator_setDefaultCutoff(target, cutoff)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) target
            real*8 cutoff
        end subroutine
        function OpenMM_DPDIntegrator_getParticleType(target, index)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) target
            integer*4 index
            integer*4 OpenMM_DPDIntegrator_getParticleType
        end function
        subroutine OpenMM_DPDIntegrator_setParticleType(target, index, &
type)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) target
            integer*4 index
        ...
        function OpenMM_DPDIntegrator_getNumTypePairs(target)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) target
            integer*4 OpenMM_DPDIntegrator_getNumTypePairs
        end function
        function OpenMM_DPDIntegrator_addTypePair(target, type1, &
type2, &
friction, &
cutoff)
            use OpenMM_Types; implicit none
            ...
            real*8 friction
            real*8 cutoff
            integer*4 OpenMM_DPDIntegrator_addTypePair
        end function
        subroutine OpenMM_DPDIntegrator_getTypePairParameters(target, pairIndex, &
type1, &
type2, &
friction, &
cutoff)
        ...
        subroutine OpenMM_DPDIntegrator_setTypePairParameters(target, pairIndex, &
type1, &
type2, &
friction, &
cutoff)
        ...
        function OpenMM_DPDIntegrator_getRandomNumberSeed(target)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) target
            integer*4 OpenMM_DPDIntegrator_getRandomNumberSeed
        end function
        subroutine OpenMM_DPDIntegrator_setRandomNumberSeed(target, seed)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) target
            integer*4 seed
        end subroutine
        subroutine OpenMM_DPDIntegrator_step(target, steps)
            use OpenMM_Types; implicit none
            type (OpenMM_DPDIntegrator) target
            integer*4 steps
        end subroutine
...
parameters)
        ...
        subroutine OpenMM_Platform_getPlatform_1(name, result)
            use OpenMM_Types; implicit none
            type (OpenMM_Platform) target
            character(*) name
            type (OpenMM_Platform) result
...
frequency)
        ...
        function OpenMM_MonteCarloBarostat_computeCurrentPressure(target, context)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloBarostat) target
            type (OpenMM_Context) context
            real*8 OpenMM_MonteCarloBarostat_computeCurrentPressure
        end function
...
k)
        ...
        ! OpenMM::LCPOForce
        subroutine OpenMM_LCPOForce_create(result)
            use OpenMM_Types; implicit none
            type (OpenMM_LCPOForce) result
        end subroutine
        subroutine OpenMM_LCPOForce_destroy(destroy)
            use OpenMM_Types; implicit none
            type (OpenMM_LCPOForce) destroy
        end subroutine
        subroutine OpenMM_LCPOForce_setUsesPeriodicBoundaryConditions(target, periodic)
            use OpenMM_Types; implicit none
            type (OpenMM_LCPOForce) target
            integer*4 periodic
        end subroutine
        function OpenMM_LCPOForce_getSurfaceTension(target)
            use OpenMM_Types; implicit none
            type (OpenMM_LCPOForce) target
            real*8 OpenMM_LCPOForce_getSurfaceTension
        end function
        subroutine OpenMM_LCPOForce_setSurfaceTension(target, surfaceTension)
            use OpenMM_Types; implicit none
            type (OpenMM_LCPOForce) target
            real*8 surfaceTension
        end subroutine
        function OpenMM_LCPOForce_getNumParticles(target)
            use OpenMM_Types; implicit none
            type (OpenMM_LCPOForce) target
            integer*4 OpenMM_LCPOForce_getNumParticles
        end function
        function OpenMM_LCPOForce_addParticle(target, radius, &
p1, &
p2, &
p3, &
p4)
            ...
            real*8 p3
            real*8 p4
            integer*4 OpenMM_LCPOForce_addParticle
        end function
        subroutine OpenMM_LCPOForce_getParticleParameters(target, index, &
radius, &
p1, &
p2, &
p3, &
p4)
        ...
        subroutine OpenMM_LCPOForce_setParticleParameters(target, index, &
radius, &
p1, &
p2, &
p3, &
p4)
        ...
        subroutine OpenMM_LCPOForce_updateParametersInContext(target, context)
            use OpenMM_Types; implicit none
            type (OpenMM_LCPOForce) target
            type (OpenMM_Context) context
        end subroutine
        function OpenMM_LCPOForce_usesPeriodicBoundaryConditions(target)
            use OpenMM_Types; implicit none
            type (OpenMM_LCPOForce) target
            integer*4 OpenMM_LCPOForce_usesPeriodicBoundaryConditions
        end function
...
thermostatedPairs)
        ...
        subroutine OpenMM_OrientationRestraintForce_create(result, k, &
referencePositions, &
particles)
            use OpenMM_Types; implicit none
            type (OpenMM_OrientationRestraintForce) result
            real*8 k
            type (OpenMM_Vec3Array) referencePositions
            type (OpenMM_IntArray) particles
        end subroutine
        subroutine OpenMM_OrientationRestraintForce_destroy(destroy)
            use OpenMM_Types; implicit none
            type (OpenMM_OrientationRestraintForce) destroy
        end subroutine
        function OpenMM_OrientationRestraintForce_getK(target)
            use OpenMM_Types; implicit none
            type (OpenMM_OrientationRestraintForce) target
            real*8 OpenMM_OrientationRestraintForce_getK
        end function
        subroutine OpenMM_OrientationRestraintForce_setK(target, k)
            use OpenMM_Types; implicit none
            type (OpenMM_OrientationRestraintForce) target
            real*8 k
        end subroutine
        subroutine OpenMM_OrientationRestraintForce_getReferencePositions(target, result)
            use OpenMM_Types; implicit none
            type (OpenMM_OrientationRestraintForce) target
            type (OpenMM_Vec3Array) result
        end subroutine
        subroutine OpenMM_OrientationRestraintForce_setReferencePositions(target, positions)
            use OpenMM_Types; implicit none
            type (OpenMM_OrientationRestraintForce) target
            type (OpenMM_Vec3Array) positions
        end subroutine
        subroutine OpenMM_OrientationRestraintForce_getParticles(target, result)
            use OpenMM_Types; implicit none
            type (OpenMM_OrientationRestraintForce) target
            type (OpenMM_IntArray) result
        end subroutine
        subroutine OpenMM_OrientationRestraintForce_setParticles(target, particles)
            use OpenMM_Types; implicit none
            type (OpenMM_OrientationRestraintForce) target
            type (OpenMM_IntArray) particles
        end subroutine
        subroutine OpenMM_OrientationRestraintForce_updateParametersInContext(target, context)
            use OpenMM_Types; implicit none
            type (OpenMM_OrientationRestraintForce) target
            type (OpenMM_Context) context
        end subroutine
        function OpenMM_OrientationRestraintForce_usesPeriodicBoundaryConditions(target)
            use OpenMM_Types; implicit none
            type (OpenMM_OrientationRestraintForce) target
            integer*4 OpenMM_OrientationRestraintForce_usesPeriodicBoundaryConditions
        end function
...
reporter)
            ...
            type (OpenMM_MinimizationReporter) reporter
        end subroutine
...
function)
        ...
        ! OpenMM::ATMForce::CoordinateTransformation
        subroutine OpenMM_ATMForce_CoordinateTransformation_destroy(destroy)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce_CoordinateTransformation) destroy
        end subroutine

        ! OpenMM::ATMForce::ParticleOffsetDisplacement
        subroutine OpenMM_ATMForce_ParticleOffsetDisplacement_create(result, pDestination1, &
pOrigin1, &
pDestination0, &
pOrigin0)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce_ParticleOffsetDisplacement) result
            integer*4 pDestination1
            integer*4 pOrigin1
            integer*4 pDestination0
            integer*4 pOrigin0
        end subroutine
        subroutine OpenMM_ATMForce_ParticleOffsetDisplacement_destroy(destroy)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce_ParticleOffsetDisplacement) destroy
        end subroutine
        function OpenMM_ATMForce_ParticleOffsetDisplacement_getDestinationPartic(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce_ParticleOffsetDisplacement) target
            integer*4 OpenMM_ATMForce_ParticleOffsetDisplacement_getDestinationPartic
        end function
        function OpenMM_ATMForce_ParticleOffsetDisplacement_getOriginParticle1(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce_ParticleOffsetDisplacement) target
            integer*4 OpenMM_ATMForce_ParticleOffsetDisplacement_getOriginParticle1
        end function
        function OpenMM_ATMForce_ParticleOffsetDisplacement_getOriginParticle0(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce_ParticleOffsetDisplacement) target
            integer*4 OpenMM_ATMForce_ParticleOffsetDisplacement_getOriginParticle0
        end function
...
k)
        ...
        subroutine OpenMM_CustomVolumeForce_create(result, energy)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomVolumeForce) result
            character(*) energy
        end subroutine
        subroutine OpenMM_CustomVolumeForce_destroy(destroy)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomVolumeForce) destroy
        end subroutine
        function OpenMM_CustomVolumeForce_getNumGlobalParameters(target)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomVolumeForce) target
            integer*4 OpenMM_CustomVolumeForce_getNumGlobalParameters
        end function
        subroutine OpenMM_CustomVolumeForce_getEnergyFunction(target, result)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomVolumeForce) target
            character(*) result
        end subroutine
        subroutine OpenMM_CustomVolumeForce_setEnergyFunction(target, energy)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomVolumeForce) target
            character(*) energy
        end subroutine
        function OpenMM_CustomVolumeForce_addGlobalParameter(target, name, &
defaultValue)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomVolumeForce) target
            character(*) name
            real*8 defaultValue
            integer*4 OpenMM_CustomVolumeForce_addGlobalParameter
        end function
        subroutine OpenMM_CustomVolumeForce_getGlobalParameterName(target, index, result)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomVolumeForce) target
            integer*4 index
            character(*) result
        end subroutine
        subroutine OpenMM_CustomVolumeForce_setGlobalParameterName(target, index, &
name)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomVolumeForce) target
            integer*4 index
        ...
        function OpenMM_CustomVolumeForce_getGlobalParameterDefaultValue(target, index)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomVolumeForce) target
            integer*4 index
            real*8 OpenMM_CustomVolumeForce_getGlobalParameterDefaultValue
        end function
        subroutine OpenMM_CustomVolumeForce_setGlobalParameterDefaultValue(target, index, &
defaultValue)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomVolumeForce) target
            integer*4 index
        ...
        function OpenMM_CustomVolumeForce_usesPeriodicBoundaryConditions(target)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomVolumeForce) target
            integer*4 OpenMM_CustomVolumeForce_usesPeriodicBoundaryConditions
        end function

        ! OpenMM::QTBIntegrator
        subroutine OpenMM_QTBIntegrator_create(result, temperature, &
frictionCoeff, &
stepSize)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) result
            real*8 temperature
            real*8 frictionCoeff
            real*8 stepSize
        end subroutine
        subroutine OpenMM_QTBIntegrator_destroy(destroy)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) destroy
        end subroutine
        function OpenMM_QTBIntegrator_getTemperature(target)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            real*8 OpenMM_QTBIntegrator_getTemperature
        end function
        subroutine OpenMM_QTBIntegrator_setTemperature(target, temp)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            real*8 temp
        end subroutine
        function OpenMM_QTBIntegrator_getFriction(target)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            real*8 OpenMM_QTBIntegrator_getFriction
        end function
        subroutine OpenMM_QTBIntegrator_setFriction(target, coeff)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            real*8 coeff
        end subroutine
        function OpenMM_QTBIntegrator_getSegmentLength(target)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            real*8 OpenMM_QTBIntegrator_getSegmentLength
        end function
        subroutine OpenMM_QTBIntegrator_setSegmentLength(target, length)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            real*8 length
        end subroutine
        function OpenMM_QTBIntegrator_getCutoffFrequency(target)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            real*8 OpenMM_QTBIntegrator_getCutoffFrequency
        end function
        subroutine OpenMM_QTBIntegrator_setCutoffFrequency(target, cutoff)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            real*8 cutoff
        end subroutine
        subroutine OpenMM_QTBIntegrator_setParticleType(target, index, &
type)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            integer*4 index
        ...
        function OpenMM_QTBIntegrator_getDefaultAdaptationRate(target)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            real*8 OpenMM_QTBIntegrator_getDefaultAdaptationRate
        end function
        subroutine OpenMM_QTBIntegrator_setDefaultAdaptationRate(target, rate)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            real*8 rate
        end subroutine
        subroutine OpenMM_QTBIntegrator_setTypeAdaptationRate(target, type, &
rate)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            integer*4 type
        ...
        subroutine OpenMM_QTBIntegrator_getAdaptedFriction(target, particle, &
friction)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            integer*4 particle
            type (OpenMM_DoubleArray) friction
        end subroutine
        function OpenMM_QTBIntegrator_getRandomNumberSeed(target)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            integer*4 OpenMM_QTBIntegrator_getRandomNumberSeed
        end function
        subroutine OpenMM_QTBIntegrator_setRandomNumberSeed(target, seed)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            integer*4 seed
        end subroutine
        subroutine OpenMM_QTBIntegrator_step(target, steps)
            use OpenMM_Types; implicit none
            type (OpenMM_QTBIntegrator) target
            integer*4 steps
        end subroutine
...
ymax)
        ...
        ! OpenMM::RGForce
        subroutine OpenMM_RGForce_create(result, particles)
            use OpenMM_Types; implicit none
            type (OpenMM_RGForce) result
            type (OpenMM_IntArray) particles
        end subroutine
        subroutine OpenMM_RGForce_destroy(destroy)
            use OpenMM_Types; implicit none
            type (OpenMM_RGForce) destroy
        end subroutine
        subroutine OpenMM_RGForce_getParticles(target, result)
            use OpenMM_Types; implicit none
            type (OpenMM_RGForce) target
            type (OpenMM_IntArray) result
        end subroutine
        subroutine OpenMM_RGForce_setParticles(target, particles)
            use OpenMM_Types; implicit none
            type (OpenMM_RGForce) target
            type (OpenMM_IntArray) particles
        end subroutine
        function OpenMM_RGForce_usesPeriodicBoundaryConditions(target)
            use OpenMM_Types; implicit none
            type (OpenMM_RGForce) target
            integer*4 OpenMM_RGForce_usesPeriodicBoundaryConditions
        end function
...
max)
        ...
        ! OpenMM::ATMForce
        subroutine OpenMM_ATMForce_create(result, energy)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) result
            character(*) energy
        end subroutine
        subroutine OpenMM_ATMForce_create_2(result, lambda1, &
lambda2, &
alpha, &
uh, &
w0, &
...
direction)
        ...
        subroutine OpenMM_ATMForce_destroy(destroy)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) destroy
        end subroutine
        subroutine OpenMM_ATMForce_Lambda1(result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            character(*) result
        end subroutine
        subroutine OpenMM_ATMForce_Lambda2(result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            character(*) result
        end subroutine
        subroutine OpenMM_ATMForce_Alpha(result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            character(*) result
        end subroutine
        subroutine OpenMM_ATMForce_Uh(result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            character(*) result
        end subroutine
        subroutine OpenMM_ATMForce_W0(result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            character(*) result
        end subroutine
        subroutine OpenMM_ATMForce_Umax(result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            character(*) result
        end subroutine
        subroutine OpenMM_ATMForce_Ubcore(result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            character(*) result
        end subroutine
        subroutine OpenMM_ATMForce_Acore(result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            character(*) result
        end subroutine
        subroutine OpenMM_ATMForce_Direction(result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            character(*) result
        end subroutine
        function OpenMM_ATMForce_getNumParticles(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 OpenMM_ATMForce_getNumParticles
        end function
        function OpenMM_ATMForce_getNumForces(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 OpenMM_ATMForce_getNumForces
        end function
        function OpenMM_ATMForce_getNumGlobalParameters(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 OpenMM_ATMForce_getNumGlobalParameters
        end function
        function OpenMM_ATMForce_getNumEnergyParameterDerivatives(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 OpenMM_ATMForce_getNumEnergyParameterDerivatives
        end function
        subroutine OpenMM_ATMForce_getEnergyFunction(target, result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            character(*) result
        end subroutine
        subroutine OpenMM_ATMForce_setEnergyFunction(target, energy)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            character(*) energy
        end subroutine
        function OpenMM_ATMForce_addForce(target, force)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            type (OpenMM_Force) force
            integer*4 OpenMM_ATMForce_addForce
        end function
        subroutine OpenMM_ATMForce_getForce(target, index, result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 index
            type (OpenMM_Force) result
        end subroutine
        function OpenMM_ATMForce_addParticle(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 OpenMM_ATMForce_addParticle
        end function
        function OpenMM_ATMForce_addParticle_1(target, displacement1, &
displacement0)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            real*8 displacement1(3)
            real*8 displacement0(3)
            integer*4 OpenMM_ATMForce_addParticle_1
        end function
        function OpenMM_ATMForce_addParticle_2(target, transformation)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            type (OpenMM_ATMForce_CoordinateTransformation) transformation
            integer*4 OpenMM_ATMForce_addParticle_2
        end function
        subroutine OpenMM_ATMForce_getParticleParameters(target, index, &
displacement1, &
displacement0)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
        ...
        subroutine OpenMM_ATMForce_setParticleParameters(target, index, &
displacement1, &
displacement0)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
        ...
        function OpenMM_ATMForce_addGlobalParameter(target, name, &
defaultValue)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            character(*) name
            real*8 defaultValue
            integer*4 OpenMM_ATMForce_addGlobalParameter
        end function
        subroutine OpenMM_ATMForce_getGlobalParameterName(target, index, result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 index
            character(*) result
        end subroutine
        subroutine OpenMM_ATMForce_setGlobalParameterName(target, index, &
name)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 index
        ...
        function OpenMM_ATMForce_getGlobalParameterDefaultValue(target, index)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 index
            real*8 OpenMM_ATMForce_getGlobalParameterDefaultValue
        end function
        subroutine OpenMM_ATMForce_setGlobalParameterDefaultValue(target, index, &
defaultValue)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 index
        ...
        subroutine OpenMM_ATMForce_addEnergyParameterDerivative(target, name)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            character(*) name
        end subroutine
        subroutine OpenMM_ATMForce_getEnergyParameterDerivativeName(target, index, result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 index
            character(*) result
        end subroutine
        subroutine OpenMM_ATMForce_updateParametersInContext(target, context)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            type (OpenMM_Context) context
        end subroutine
        function OpenMM_ATMForce_usesPeriodicBoundaryConditions(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 OpenMM_ATMForce_usesPeriodicBoundaryConditions
        end function
        subroutine OpenMM_ATMForce_getPerturbationEnergy(target, context, &
u1, &
u0, &
energy)
            use OpenMM_Types; implicit none
        ...
        subroutine OpenMM_ATMForce_setParticleTransformation(target, index, &
transformation)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 index
        ...
        subroutine OpenMM_ATMForce_getParticleTransformation(target, index, result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce) target
            integer*4 index
            type (OpenMM_ATMForce_CoordinateTransformation) result
        end subroutine

        ! OpenMM::MinimizationReporter
        subroutine OpenMM_MinimizationReporter_create(result)
            use OpenMM_Types; implicit none
            type (OpenMM_MinimizationReporter) result
        end subroutine
        subroutine OpenMM_MinimizationReporter_destroy(destroy)
            use OpenMM_Types; implicit none
            type (OpenMM_MinimizationReporter) destroy
        end subroutine
        function OpenMM_MinimizationReporter_report(target, iteration, &
x, &
grad, &
args)
            use OpenMM_Types; implicit none
            type (OpenMM_MinimizationReporter) target
            integer*4 iteration
            type (OpenMM_DoubleArray) x
            type (OpenMM_DoubleArray) grad
            type (OpenMM_ParameterArray) args
            integer*4 OpenMM_MinimizationReporter_report
        end function
...
localPosition)
        ...
        function OpenMM_CompoundIntegrator_getIntegrationForceGroups(target)
            use OpenMM_Types; implicit none
            type (OpenMM_CompoundIntegrator) target
            integer*4 OpenMM_CompoundIntegrator_getIntegrationForceGroups
        end function
        subroutine OpenMM_CompoundIntegrator_setIntegrationForceGroups(target, groups)
            use OpenMM_Types; implicit none
            type (OpenMM_CompoundIntegrator) target
            integer*4 groups
        end subroutine
...
frequency)
        ...
        subroutine OpenMM_ATMForce_FixedDisplacement_create(result, displacement1, &
displacement0)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce_FixedDisplacement) result
            real*8 displacement1(3)
            real*8 displacement0(3)
        end subroutine
        subroutine OpenMM_ATMForce_FixedDisplacement_destroy(destroy)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce_FixedDisplacement) destroy
        end subroutine
        subroutine OpenMM_ATMForce_FixedDisplacement_getFixedDisplacement1(target, result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce_FixedDisplacement) target
            real*8 result(3)
        end subroutine
        subroutine OpenMM_ATMForce_FixedDisplacement_getFixedDisplacement0(target, result)
            use OpenMM_Types; implicit none
            type (OpenMM_ATMForce_FixedDisplacement) target
            real*8 result(3)
        end subroutine
...
epsilonScale)
        ...
        function OpenMM_CustomNonbondedForce_getNumComputedValues(target)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomNonbondedForce) target
            integer*4 OpenMM_CustomNonbondedForce_getNumComputedValues
        end function
...
max)
        ...
        function OpenMM_CustomNonbondedForce_addComputedValue(target, name, &
expression)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomNonbondedForce) target
            character(*) name
            character(*) expression
            integer*4 OpenMM_CustomNonbondedForce_addComputedValue
        end function
        subroutine OpenMM_CustomNonbondedForce_getComputedValueParameters(target, index, &
name, &
expression)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomNonbondedForce) target
        ...
        subroutine OpenMM_CustomNonbondedForce_setComputedValueParameters(target, index, &
name, &
expression)
            use OpenMM_Types; implicit none
            type (OpenMM_CustomNonbondedForce) target
...
set2)
        ...
        subroutine OpenMM_ConstantPotentialForce_create(result)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) result
        end subroutine
        subroutine OpenMM_ConstantPotentialForce_destroy(destroy)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) destroy
        end subroutine
        function OpenMM_ConstantPotentialForce_getNumParticles(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 OpenMM_ConstantPotentialForce_getNumParticles
        end function
        function OpenMM_ConstantPotentialForce_getNumExceptions(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 OpenMM_ConstantPotentialForce_getNumExceptions
        end function
        function OpenMM_ConstantPotentialForce_getCutoffDistance(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            real*8 OpenMM_ConstantPotentialForce_getCutoffDistance
        end function
        subroutine OpenMM_ConstantPotentialForce_setCutoffDistance(target, distance)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            real*8 distance
        end subroutine
        function OpenMM_ConstantPotentialForce_getEwaldErrorTolerance(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            real*8 OpenMM_ConstantPotentialForce_getEwaldErrorTolerance
        end function
        subroutine OpenMM_ConstantPotentialForce_setEwaldErrorTolerance(target, tol)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            real*8 tol
        end subroutine
        subroutine OpenMM_ConstantPotentialForce_getPMEParameters(target, alpha, &
nx, &
ny, &
nz)
            use OpenMM_Types; implicit none
        ...
        subroutine OpenMM_ConstantPotentialForce_setPMEParameters(target, alpha, &
nx, &
ny, &
nz)
            use OpenMM_Types; implicit none
        ...
        subroutine OpenMM_ConstantPotentialForce_getPMEParametersInContext(target, context, &
alpha, &
nx, &
ny, &
nz)
        ...
        function OpenMM_ConstantPotentialForce_addParticle(target, charge)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            real*8 charge
            integer*4 OpenMM_ConstantPotentialForce_addParticle
        end function
        subroutine OpenMM_ConstantPotentialForce_getParticleParameters(target, index, &
charge)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 index
        ...
        subroutine OpenMM_ConstantPotentialForce_setParticleParameters(target, index, &
charge)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 index
        ...
        function OpenMM_ConstantPotentialForce_addException(target, particle1, &
particle2, &
chargeProd, &
replace)
            use OpenMM_Types; implicit none
            ...
            real*8 chargeProd
            integer*4 replace
            integer*4 OpenMM_ConstantPotentialForce_addException
        end function
        subroutine OpenMM_ConstantPotentialForce_getExceptionParameters(target, index, &
particle1, &
particle2, &
chargeProd)
            use OpenMM_Types; implicit none
        ...
        subroutine OpenMM_ConstantPotentialForce_setExceptionParameters(target, index, &
particle1, &
particle2, &
chargeProd)
            use OpenMM_Types; implicit none
        ...
        subroutine OpenMM_ConstantPotentialForce_createExceptionsFromBonds(target, bonds, &
coulomb14Scale)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            type (OpenMM_BondArray) bonds
        ...
        subroutine OpenMM_ConstantPotentialForce_updateParametersInContext(target, context)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            type (OpenMM_Context) context
        end subroutine
        function OpenMM_ConstantPotentialForce_usesPeriodicBoundaryConditions(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 OpenMM_ConstantPotentialForce_usesPeriodicBoundaryConditions
        end function
        function OpenMM_ConstantPotentialForce_getExceptionsUsePeriodicBoundaryC(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 OpenMM_ConstantPotentialForce_getExceptionsUsePeriodicBoundaryC
        end function
        subroutine OpenMM_ConstantPotentialForce_setExceptionsUsePeriodicBoundaryC(target, periodic)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 periodic
        end subroutine
        function OpenMM_ConstantPotentialForce_getConstantPotentialMethod(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 OpenMM_ConstantPotentialForce_getConstantPotentialMethod
        end function
        subroutine OpenMM_ConstantPotentialForce_setConstantPotentialMethod(target, method)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 method
        end subroutine
        function OpenMM_ConstantPotentialForce_getUsePreconditioner(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 OpenMM_ConstantPotentialForce_getUsePreconditioner
        end function
        subroutine OpenMM_ConstantPotentialForce_setUsePreconditioner(target, use)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 use
        end subroutine
        function OpenMM_ConstantPotentialForce_getCGErrorTolerance(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            real*8 OpenMM_ConstantPotentialForce_getCGErrorTolerance
        end function
        subroutine OpenMM_ConstantPotentialForce_setCGErrorTolerance(target, tol)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            real*8 tol
        end subroutine
        function OpenMM_ConstantPotentialForce_getNumElectrodes(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 OpenMM_ConstantPotentialForce_getNumElectrodes
        end function
        function OpenMM_ConstantPotentialForce_addElectrode(target, electrodeParticles, &
potential, &
gaussianWidth, &
thomasFermiScale)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            type (OpenMM_IntSet) electrodeParticles
            real*8 potential
            real*8 gaussianWidth
            real*8 thomasFermiScale
            integer*4 OpenMM_ConstantPotentialForce_addElectrode
        end function
        subroutine OpenMM_ConstantPotentialForce_getElectrodeParameters(target, index, &
electrodeParticles, &
potential, &
gaussianWidth, &
thomasFermiScale)
        ...
        subroutine OpenMM_ConstantPotentialForce_setElectrodeParameters(target, index, &
electrodeParticles, &
potential, &
gaussianWidth, &
thomasFermiScale)
        ...
        function OpenMM_ConstantPotentialForce_getUseChargeConstraint(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 OpenMM_ConstantPotentialForce_getUseChargeConstraint
        end function
        subroutine OpenMM_ConstantPotentialForce_setUseChargeConstraint(target, use)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            integer*4 use
        end subroutine
        function OpenMM_ConstantPotentialForce_getChargeConstraintTarget(target)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            real*8 OpenMM_ConstantPotentialForce_getChargeConstraintTarget
        end function
        subroutine OpenMM_ConstantPotentialForce_setChargeConstraintTarget(target, charge)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            real*8 charge
        end subroutine
        subroutine OpenMM_ConstantPotentialForce_getExternalField(target, field)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            real*8 field(3)
        end subroutine
        subroutine OpenMM_ConstantPotentialForce_setExternalField(target, field)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            real*8 field(3)
        end subroutine
        subroutine OpenMM_ConstantPotentialForce_getCharges(target, context, &
charges)
            use OpenMM_Types; implicit none
            type (OpenMM_ConstantPotentialForce) target
            type (OpenMM_Context) context
            type (OpenMM_DoubleArray) charges
        end subroutine
...
weight2)
        ...
        ! OpenMM::SymmetrySite
        subroutine OpenMM_SymmetrySite_create(result, particle, &
Rx, &
Ry, &
Rz, &
v, &
useBoxVectors)
            use OpenMM_Types; implicit none
            type (OpenMM_SymmetrySite) result
            integer*4 particle
            real*8 Rx(3)
            real*8 Ry(3)
            real*8 Rz(3)
            real*8 v(3)
            integer*4 useBoxVectors
        end subroutine
        subroutine OpenMM_SymmetrySite_destroy(destroy)
            use OpenMM_Types; implicit none
            type (OpenMM_SymmetrySite) destroy
        end subroutine
        subroutine OpenMM_SymmetrySite_getRotationMatrix(target, Rx, &
Ry, &
Rz)
            use OpenMM_Types; implicit none
            type (OpenMM_SymmetrySite) target
            real*8 Rx(3)
            real*8 Ry(3)
            real*8 Rz(3)
        end subroutine
        subroutine OpenMM_SymmetrySite_getOffsetVector(target, result)
            use OpenMM_Types; implicit none
            type (OpenMM_SymmetrySite) target
            real*8 result(3)
        end subroutine
        function OpenMM_SymmetrySite_getUseBoxVectors(target)
            use OpenMM_Types; implicit none
            type (OpenMM_SymmetrySite) target
            integer*4 OpenMM_SymmetrySite_getUseBoxVectors
        end function
...
scaleMoleculesAsRigid)
        ...
        subroutine OpenMM_MonteCarloFlexibleBarostat_computeCurrentPressure(target, context, &
pressure)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloFlexibleBarostat) target
            type (OpenMM_Context) context
            type (OpenMM_DoubleArray) pressure
        end subroutine
