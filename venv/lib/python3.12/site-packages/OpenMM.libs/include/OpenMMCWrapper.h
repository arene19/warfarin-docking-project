...
typedef struct OpenMM_LCPOForce_struct OpenMM_LCPOForce;
...
typedef struct OpenMM_OrientationRestraintForce_struct OpenMM_OrientationRestraintForce;
...
typedef struct OpenMM_ATMForce_CoordinateTransformation_struct OpenMM_ATMForce_CoordinateTransformation;
typedef struct OpenMM_ATMForce_ParticleOffsetDisplacement_struct OpenMM_ATMForce_ParticleOffsetDisplacement;
...
typedef struct OpenMM_QTBIntegrator_struct OpenMM_QTBIntegrator;
...
typedef struct OpenMM_RGForce_struct OpenMM_RGForce;
...
typedef struct OpenMM_ATMForce_FixedDisplacement_struct OpenMM_ATMForce_FixedDisplacement;
...
typedef struct OpenMM_ConstantPotentialForce_struct OpenMM_ConstantPotentialForce;
...
typedef struct OpenMM_SymmetrySite_struct OpenMM_SymmetrySite;
...
/* LCPOForce */
extern OPENMM_EXPORT OpenMM_LCPOForce* OpenMM_LCPOForce_create();
extern OPENMM_EXPORT void OpenMM_LCPOForce_destroy(OpenMM_LCPOForce* target);
extern OPENMM_EXPORT void OpenMM_LCPOForce_setUsesPeriodicBoundaryConditions(OpenMM_LCPOForce* target, OpenMM_Boolean periodic);
extern OPENMM_EXPORT double OpenMM_LCPOForce_getSurfaceTension(const OpenMM_LCPOForce* target);
extern OPENMM_EXPORT void OpenMM_LCPOForce_setSurfaceTension(OpenMM_LCPOForce* target, double surfaceTension);
extern OPENMM_EXPORT int OpenMM_LCPOForce_getNumParticles(const OpenMM_LCPOForce* target);
extern OPENMM_EXPORT int OpenMM_LCPOForce_addParticle(OpenMM_LCPOForce* target, double radius, double p1, double p2, double p3, double p4);
extern OPENMM_EXPORT void OpenMM_LCPOForce_getParticleParameters(const OpenMM_LCPOForce* target, int index, double* radius, double* p1, double* p2, double* p3, double* p4);
extern OPENMM_EXPORT void OpenMM_LCPOForce_setParticleParameters(OpenMM_LCPOForce* target, int index, double radius, double p1, double p2, double p3, double p4);
extern OPENMM_EXPORT void OpenMM_LCPOForce_updateParametersInContext(OpenMM_LCPOForce* target, OpenMM_Context* context);
extern OPENMM_EXPORT OpenMM_Boolean OpenMM_LCPOForce_usesPeriodicBoundaryConditions(const OpenMM_LCPOForce* target);
...
extern OPENMM_EXPORT OpenMM_OrientationRestraintForce* OpenMM_OrientationRestraintForce_create(double k, const OpenMM_Vec3Array* referencePositions, const OpenMM_IntArray* particles);
extern OPENMM_EXPORT void OpenMM_OrientationRestraintForce_destroy(OpenMM_OrientationRestraintForce* target);
extern OPENMM_EXPORT double OpenMM_OrientationRestraintForce_getK(const OpenMM_OrientationRestraintForce* target);
extern OPENMM_EXPORT void OpenMM_OrientationRestraintForce_setK(OpenMM_OrientationRestraintForce* target, double k);
extern OPENMM_EXPORT const OpenMM_Vec3Array* OpenMM_OrientationRestraintForce_getReferencePositions(const OpenMM_OrientationRestraintForce* target);
extern OPENMM_EXPORT void OpenMM_OrientationRestraintForce_setReferencePositions(OpenMM_OrientationRestraintForce* target, const OpenMM_Vec3Array* positions);
extern OPENMM_EXPORT const OpenMM_IntArray* OpenMM_OrientationRestraintForce_getParticles(const OpenMM_OrientationRestraintForce* target);
extern OPENMM_EXPORT void OpenMM_OrientationRestraintForce_setParticles(OpenMM_OrientationRestraintForce* target, const OpenMM_IntArray* particles);
extern OPENMM_EXPORT void OpenMM_OrientationRestraintForce_updateParametersInContext(OpenMM_OrientationRestraintForce* target, OpenMM_Context* context);
extern OPENMM_EXPORT OpenMM_Boolean OpenMM_OrientationRestraintForce_usesPeriodicBoundaryConditions(const OpenMM_OrientationRestraintForce* target);
...
extern OPENMM_EXPORT void OpenMM_ATMForce_CoordinateTransformation_destroy(OpenMM_ATMForce_CoordinateTransformation* target);

/* ParticleOffsetDisplacement */
extern OPENMM_EXPORT OpenMM_ATMForce_ParticleOffsetDisplacement* OpenMM_ATMForce_ParticleOffsetDisplacement_create(int pDestination1, int pOrigin1, int pDestination0, int pOrigin0);
extern OPENMM_EXPORT void OpenMM_ATMForce_ParticleOffsetDisplacement_destroy(OpenMM_ATMForce_ParticleOffsetDisplacement* target);
extern OPENMM_EXPORT int OpenMM_ATMForce_ParticleOffsetDisplacement_getDestinationParticle1(const OpenMM_ATMForce_ParticleOffsetDisplacement* target);
extern OPENMM_EXPORT int OpenMM_ATMForce_ParticleOffsetDisplacement_getOriginParticle1(const OpenMM_ATMForce_ParticleOffsetDisplacement* target);
extern OPENMM_EXPORT int OpenMM_ATMForce_ParticleOffsetDisplacement_getDestinationParticle0(const OpenMM_ATMForce_ParticleOffsetDisplacement* target);
extern OPENMM_EXPORT int OpenMM_ATMForce_ParticleOffsetDisplacement_getOriginParticle0(const OpenMM_ATMForce_ParticleOffsetDisplacement* target);
...
/* QTBIntegrator */
extern OPENMM_EXPORT OpenMM_QTBIntegrator* OpenMM_QTBIntegrator_create(double temperature, double frictionCoeff, double stepSize);
extern OPENMM_EXPORT void OpenMM_QTBIntegrator_destroy(OpenMM_QTBIntegrator* target);
extern OPENMM_EXPORT double OpenMM_QTBIntegrator_getTemperature(const OpenMM_QTBIntegrator* target);
extern OPENMM_EXPORT void OpenMM_QTBIntegrator_setTemperature(OpenMM_QTBIntegrator* target, double temp);
extern OPENMM_EXPORT double OpenMM_QTBIntegrator_getFriction(const OpenMM_QTBIntegrator* target);
extern OPENMM_EXPORT void OpenMM_QTBIntegrator_setFriction(OpenMM_QTBIntegrator* target, double coeff);
extern OPENMM_EXPORT double OpenMM_QTBIntegrator_getSegmentLength(const OpenMM_QTBIntegrator* target);
extern OPENMM_EXPORT void OpenMM_QTBIntegrator_setSegmentLength(OpenMM_QTBIntegrator* target, double length);
extern OPENMM_EXPORT double OpenMM_QTBIntegrator_getCutoffFrequency(const OpenMM_QTBIntegrator* target);
extern OPENMM_EXPORT void OpenMM_QTBIntegrator_setCutoffFrequency(OpenMM_QTBIntegrator* target, double cutoff);
extern OPENMM_EXPORT void OpenMM_QTBIntegrator_setParticleType(OpenMM_QTBIntegrator* target, int index, int type);
extern OPENMM_EXPORT double OpenMM_QTBIntegrator_getDefaultAdaptationRate(const OpenMM_QTBIntegrator* target);
extern OPENMM_EXPORT void OpenMM_QTBIntegrator_setDefaultAdaptationRate(OpenMM_QTBIntegrator* target, double rate);
extern OPENMM_EXPORT void OpenMM_QTBIntegrator_setTypeAdaptationRate(OpenMM_QTBIntegrator* target, int type, double rate);
extern OPENMM_EXPORT void OpenMM_QTBIntegrator_getAdaptedFriction(const OpenMM_QTBIntegrator* target, int particle, OpenMM_DoubleArray* friction);
extern OPENMM_EXPORT int OpenMM_QTBIntegrator_getRandomNumberSeed(const OpenMM_QTBIntegrator* target);
extern OPENMM_EXPORT void OpenMM_QTBIntegrator_setRandomNumberSeed(OpenMM_QTBIntegrator* target, int seed);
extern OPENMM_EXPORT void OpenMM_QTBIntegrator_step(OpenMM_QTBIntegrator* target, int steps);
...
/* RGForce */
extern OPENMM_EXPORT OpenMM_RGForce* OpenMM_RGForce_create(const OpenMM_IntArray* particles);
extern OPENMM_EXPORT void OpenMM_RGForce_destroy(OpenMM_RGForce* target);
extern OPENMM_EXPORT const OpenMM_IntArray* OpenMM_RGForce_getParticles(const OpenMM_RGForce* target);
extern OPENMM_EXPORT void OpenMM_RGForce_setParticles(OpenMM_RGForce* target, const OpenMM_IntArray* particles);
extern OPENMM_EXPORT OpenMM_Boolean OpenMM_RGForce_usesPeriodicBoundaryConditions(const OpenMM_RGForce* target);
...
extern OPENMM_EXPORT int OpenMM_ATMForce_addParticle(OpenMM_ATMForce* target);
extern OPENMM_EXPORT int OpenMM_ATMForce_addParticle_1(OpenMM_ATMForce* target, const OpenMM_Vec3* displacement1, const OpenMM_Vec3* displacement0);
extern OPENMM_EXPORT int OpenMM_ATMForce_addParticle_2(OpenMM_ATMForce* target, OpenMM_ATMForce_CoordinateTransformation* transformation);
...
extern OPENMM_EXPORT void OpenMM_ATMForce_setParticleTransformation(OpenMM_ATMForce* target, int index, OpenMM_ATMForce_CoordinateTransformation* transformation);
extern OPENMM_EXPORT const OpenMM_ATMForce_CoordinateTransformation* OpenMM_ATMForce_getParticleTransformation(const OpenMM_ATMForce* target, int index);
...
/* FixedDisplacement */
extern OPENMM_EXPORT OpenMM_ATMForce_FixedDisplacement* OpenMM_ATMForce_FixedDisplacement_create(const OpenMM_Vec3* displacement1, const OpenMM_Vec3* displacement0);
extern OPENMM_EXPORT void OpenMM_ATMForce_FixedDisplacement_destroy(OpenMM_ATMForce_FixedDisplacement* target);
extern OPENMM_EXPORT const OpenMM_Vec3* OpenMM_ATMForce_FixedDisplacement_getFixedDisplacement1(const OpenMM_ATMForce_FixedDisplacement* target);
extern OPENMM_EXPORT const OpenMM_Vec3* OpenMM_ATMForce_FixedDisplacement_getFixedDisplacement0(const OpenMM_ATMForce_FixedDisplacement* target);
...
typedef enum {
  OpenMM_ConstantPotentialForce_CG = 0, OpenMM_ConstantPotentialForce_Matrix = 1
} OpenMM_ConstantPotentialForce_ConstantPotentialMethod;

extern OPENMM_EXPORT OpenMM_ConstantPotentialForce* OpenMM_ConstantPotentialForce_create();
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_destroy(OpenMM_ConstantPotentialForce* target);
extern OPENMM_EXPORT int OpenMM_ConstantPotentialForce_getNumParticles(const OpenMM_ConstantPotentialForce* target);
extern OPENMM_EXPORT int OpenMM_ConstantPotentialForce_getNumExceptions(const OpenMM_ConstantPotentialForce* target);
extern OPENMM_EXPORT double OpenMM_ConstantPotentialForce_getCutoffDistance(const OpenMM_ConstantPotentialForce* target);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_setCutoffDistance(OpenMM_ConstantPotentialForce* target, double distance);
extern OPENMM_EXPORT double OpenMM_ConstantPotentialForce_getEwaldErrorTolerance(const OpenMM_ConstantPotentialForce* target);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_setEwaldErrorTolerance(OpenMM_ConstantPotentialForce* target, double tol);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_getPMEParameters(const OpenMM_ConstantPotentialForce* target, double* alpha, int* nx, int* ny, int* nz);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_setPMEParameters(OpenMM_ConstantPotentialForce* target, double alpha, int nx, int ny, int nz);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_getPMEParametersInContext(const OpenMM_ConstantPotentialForce* target, const OpenMM_Context* context, double* alpha, int* nx, int* ny, int* nz);
extern OPENMM_EXPORT int OpenMM_ConstantPotentialForce_addParticle(OpenMM_ConstantPotentialForce* target, double charge);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_getParticleParameters(const OpenMM_ConstantPotentialForce* target, int index, double* charge);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_setParticleParameters(OpenMM_ConstantPotentialForce* target, int index, double charge);
extern OPENMM_EXPORT int OpenMM_ConstantPotentialForce_addException(OpenMM_ConstantPotentialForce* target, int particle1, int particle2, double chargeProd, OpenMM_Boolean replace);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_getExceptionParameters(const OpenMM_ConstantPotentialForce* target, int index, int* particle1, int* particle2, double* chargeProd);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_setExceptionParameters(OpenMM_ConstantPotentialForce* target, int index, int particle1, int particle2, double chargeProd);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_createExceptionsFromBonds(OpenMM_ConstantPotentialForce* target, const OpenMM_BondArray* bonds, double coulomb14Scale);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_updateParametersInContext(OpenMM_ConstantPotentialForce* target, OpenMM_Context* context);
extern OPENMM_EXPORT OpenMM_Boolean OpenMM_ConstantPotentialForce_usesPeriodicBoundaryConditions(const OpenMM_ConstantPotentialForce* target);
extern OPENMM_EXPORT OpenMM_Boolean OpenMM_ConstantPotentialForce_getExceptionsUsePeriodicBoundaryConditions(const OpenMM_ConstantPotentialForce* target);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_setExceptionsUsePeriodicBoundaryConditions(OpenMM_ConstantPotentialForce* target, OpenMM_Boolean periodic);
extern OPENMM_EXPORT OpenMM_ConstantPotentialForce_ConstantPotentialMethod OpenMM_ConstantPotentialForce_getConstantPotentialMethod(const OpenMM_ConstantPotentialForce* target);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_setConstantPotentialMethod(OpenMM_ConstantPotentialForce* target, OpenMM_ConstantPotentialForce_ConstantPotentialMethod method);
extern OPENMM_EXPORT OpenMM_Boolean OpenMM_ConstantPotentialForce_getUsePreconditioner(const OpenMM_ConstantPotentialForce* target);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_setUsePreconditioner(OpenMM_ConstantPotentialForce* target, OpenMM_Boolean use);
extern OPENMM_EXPORT double OpenMM_ConstantPotentialForce_getCGErrorTolerance(const OpenMM_ConstantPotentialForce* target);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_setCGErrorTolerance(OpenMM_ConstantPotentialForce* target, double tol);
extern OPENMM_EXPORT int OpenMM_ConstantPotentialForce_getNumElectrodes(const OpenMM_ConstantPotentialForce* target);
extern OPENMM_EXPORT int OpenMM_ConstantPotentialForce_addElectrode(OpenMM_ConstantPotentialForce* target, const OpenMM_IntSet* electrodeParticles, double potential, double gaussianWidth, double thomasFermiScale);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_getElectrodeParameters(const OpenMM_ConstantPotentialForce* target, int index, OpenMM_IntSet* electrodeParticles, double* potential, double* gaussianWidth, double* thomasFermiScale);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_setElectrodeParameters(OpenMM_ConstantPotentialForce* target, int index, const OpenMM_IntSet* electrodeParticles, double potential, double gaussianWidth, double thomasFermiScale);
extern OPENMM_EXPORT OpenMM_Boolean OpenMM_ConstantPotentialForce_getUseChargeConstraint(const OpenMM_ConstantPotentialForce* target);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_setUseChargeConstraint(OpenMM_ConstantPotentialForce* target, OpenMM_Boolean use);
extern OPENMM_EXPORT double OpenMM_ConstantPotentialForce_getChargeConstraintTarget(const OpenMM_ConstantPotentialForce* target);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_setChargeConstraintTarget(OpenMM_ConstantPotentialForce* target, double charge);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_getExternalField(const OpenMM_ConstantPotentialForce* target, OpenMM_Vec3* field);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_setExternalField(OpenMM_ConstantPotentialForce* target, const OpenMM_Vec3* field);
extern OPENMM_EXPORT void OpenMM_ConstantPotentialForce_getCharges(const OpenMM_ConstantPotentialForce* target, OpenMM_Context* context, OpenMM_DoubleArray* charges);
...
/* SymmetrySite */
extern OPENMM_EXPORT OpenMM_SymmetrySite* OpenMM_SymmetrySite_create(int particle, const OpenMM_Vec3* Rx, const OpenMM_Vec3* Ry, const OpenMM_Vec3* Rz, const OpenMM_Vec3* v, OpenMM_Boolean useBoxVectors);
extern OPENMM_EXPORT void OpenMM_SymmetrySite_destroy(OpenMM_SymmetrySite* target);
extern OPENMM_EXPORT void OpenMM_SymmetrySite_getRotationMatrix(const OpenMM_SymmetrySite* target, OpenMM_Vec3* Rx, OpenMM_Vec3* Ry, OpenMM_Vec3* Rz);
extern OPENMM_EXPORT const OpenMM_Vec3* OpenMM_SymmetrySite_getOffsetVector(const OpenMM_SymmetrySite* target);
extern OPENMM_EXPORT OpenMM_Boolean OpenMM_SymmetrySite_getUseBoxVectors(const OpenMM_SymmetrySite* target);
