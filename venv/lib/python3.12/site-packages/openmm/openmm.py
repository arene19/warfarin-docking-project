...
class vectormapstringstring(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _openmm.vectormapstringstring_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _openmm.vectormapstringstring___nonzero__(self)

    def __bool__(self):
        return _openmm.vectormapstringstring___bool__(self)

    def __len__(self):
        return _openmm.vectormapstringstring___len__(self)

    def __getslice__(self, i, j):
        return _openmm.vectormapstringstring___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _openmm.vectormapstringstring___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _openmm.vectormapstringstring___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _openmm.vectormapstringstring___delitem__(self, *args)

    def __getitem__(self, *args):
        return _openmm.vectormapstringstring___getitem__(self, *args)

    def __setitem__(self, *args):
        return _openmm.vectormapstringstring___setitem__(self, *args)

    def pop(self):
        return _openmm.vectormapstringstring_pop(self)

    def append(self, x):
        return _openmm.vectormapstringstring_append(self, x)

    def empty(self):
        return _openmm.vectormapstringstring_empty(self)

    def size(self):
        return _openmm.vectormapstringstring_size(self)

    def swap(self, v):
        return _openmm.vectormapstringstring_swap(self, v)

    def begin(self):
        return _openmm.vectormapstringstring_begin(self)

    def end(self):
        return _openmm.vectormapstringstring_end(self)

    def rbegin(self):
        return _openmm.vectormapstringstring_rbegin(self)

    def rend(self):
        return _openmm.vectormapstringstring_rend(self)

    def clear(self):
        return _openmm.vectormapstringstring_clear(self)

    def get_allocator(self):
        return _openmm.vectormapstringstring_get_allocator(self)

    def pop_back(self):
        return _openmm.vectormapstringstring_pop_back(self)

    def erase(self, *args):
        return _openmm.vectormapstringstring_erase(self, *args)

    def __init__(self, *args):
        _openmm.vectormapstringstring_swiginit(self, _openmm.new_vectormapstringstring(*args))

    def push_back(self, x):
        return _openmm.vectormapstringstring_push_back(self, x)

    def front(self):
        return _openmm.vectormapstringstring_front(self)

    def back(self):
        return _openmm.vectormapstringstring_back(self)

    def assign(self, n, x):
        return _openmm.vectormapstringstring_assign(self, n, x)

    def resize(self, *args):
        return _openmm.vectormapstringstring_resize(self, *args)

    def insert(self, *args):
        return _openmm.vectormapstringstring_insert(self, *args)

    def reserve(self, n):
        return _openmm.vectormapstringstring_reserve(self, n)

    def capacity(self):
        return _openmm.vectormapstringstring_capacity(self)
    __swig_destroy__ = _openmm.delete_vectormapstringstring

# Register vectormapstringstring in _openmm:
_openmm.vectormapstringstring_swigregister(vectormapstringstring)
class mapii(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class ComputationWrapper(object):
    r"""Proxy of C++ OpenMM::ComputationWrapper class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, computation):
        r"""__init__(self, computation) -> ComputationWrapper"""
        _openmm.ComputationWrapper_swiginit(self, _openmm.new_ComputationWrapper(computation))
    __swig_destroy__ = _openmm.delete_ComputationWrapper

    def compute(self, state, energy, forces, forcesAreDouble):
        r"""compute(self, state, energy, forces, forcesAreDouble)"""
        return _openmm.ComputationWrapper_compute(self, state, energy, forces, forcesAreDouble)

# Register ComputationWrapper in _openmm:
_openmm.ComputationWrapper_swigregister(ComputationWrapper)

def _createPythonForce(*args):
    r"""_createPythonForce(computation, globalParameters={}) -> PythonForce"""
    return _openmm._createPythonForce(*args)
class PythonForceProxy(object):
    r"""Proxy of C++ OpenMM::PythonForceProxy class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(self) -> PythonForceProxy"""
        _openmm.PythonForceProxy_swiginit(self, _openmm.new_PythonForceProxy())

    @staticmethod
    def hexEncode(input):
        r"""hexEncode(input) -> std::string"""
        return _openmm.PythonForceProxy_hexEncode(input)

    @staticmethod
    def hexDecode(input):
        r"""hexDecode(input) -> std::vector< char,std::allocator< char > >"""
        return _openmm.PythonForceProxy_hexDecode(input)

    def serialize(self, object, node):
        r"""serialize(self, object, node)"""
        return _openmm.PythonForceProxy_serialize(self, object, node)

    def deserialize(self, node):
        r"""deserialize(self, node) -> void *"""
        return _openmm.PythonForceProxy_deserialize(self, node)
    __swig_destroy__ = _openmm.delete_PythonForceProxy

# Register PythonForceProxy in _openmm:
_openmm.PythonForceProxy_swigregister(PythonForceProxy)

def registerPythonForceProxy():
    r"""registerPythonForceProxy()"""
    return _openmm.registerPythonForceProxy()
class Force(object):
    r"""
...
class LCPOForce(Force):
    ...
    def setUsesPeriodicBoundaryConditions(self, periodic):
        ...
        """
        return _openmm.LCPOForce_setUsesPeriodicBoundaryConditions(self, periodic)

    def getSurfaceTension(self):
        r"""
        getSurfaceTension(self) -> double
        ...
        """
        val = _openmm.LCPOForce_getSurfaceTension(self)

        val=unit.Quantity(val, unit.kilojoule_per_mole/unit.nanometer**2)


        return val


    def setSurfaceTension(self, surfaceTension):
        r"""
        ...
        if unit.is_quantity(surfaceTension):
            surfaceTension = surfaceTension.value_in_unit(unit.kilojoule_per_mole/unit.nanometer**2)


        return _openmm.LCPOForce_setSurfaceTension(self, surfaceTension)
    ...
    def getNumParticles(self):
        ...
        Get the number of particles for which force field parameters have been defined.
        """
        return _openmm.LCPOForce_getNumParticles(self)

    def addParticle(self, radius, p1, p2, p3, p4):
        r"""
        ...
        ----------
        radius : float
            the radius of the particle for the LCPO method, including the solvent probe radius if applicable, measured in nm
        p1 : float
            the value of the LCPO parameter P1 for the particle
        p2 : float
            the value of the LCPO parameter P2 for the particle
        p3 : float
            the value of the LCPO parameter P3 for the particle
        p4 : float
            the value of the LCPO parameter P4 for the particle, measured in nm^-2
        ...
        if unit.is_quantity(radius):
            radius = radius.value_in_unit(unit.nanometer)
        if unit.is_quantity(p4):
            p4 = p4.value_in_unit(unit.nanometer**-2)


        return _openmm.LCPOForce_addParticle(self, radius, p1, p2, p3, p4)
    ...
    def getParticleParameters(self, index):
        ...
        p4 : float
            the value of the LCPO parameter P4 for the particle, measured in nm^-2
        """
        val = _openmm.LCPOForce_getParticleParameters(self, index)

        val[0]=unit.Quantity(val[0], unit.nanometer)
        val[4]=unit.Quantity(val[4], unit.nanometer**-2)


        return val


    def setParticleParameters(self, index, radius, p1, p2, p3, p4):
        r"""
        ...
        return _openmm.LCPOForce_setParticleParameters(self, index, radius, p1, p2, p3, p4)
    ...
    def updateParametersInContext(self, context):
        ...
        """
        return _openmm.LCPOForce_updateParametersInContext(self, context)
    ...
    def usesPeriodicBoundaryConditions(self):
        ...
        bool
            true if force uses PBC and false otherwise
        """
        return _openmm.LCPOForce_usesPeriodicBoundaryConditions(self)
    ...
    def __init__(self, *args):
        ...
        Create an LCPOForce.
        """
        _openmm.LCPOForce_swiginit(self, _openmm.new_LCPOForce(*args))
    __swig_destroy__ = _openmm.delete_LCPOForce

# Register LCPOForce in _openmm:
_openmm.LCPOForce_swigregister(LCPOForce)
...
class Platform(object):
    ...
    * </verbatim>
    ...
    def getDevices(self, *args):
        r"""
        getDevices(self, filters={}) -> vectormapstringstring
        Get a list of available devices for this Platform.

        This method is relevant to Platforms that offer a choice of devices to run calculations on. For example, if a Platform does calculations on GPUs and it is running on a computer with multiple GPUs, you can choose which one to use by specifying Platform-specific properties.

        The returned value contains one entry for each available device. Each entry contains the values of any properties that are specific to the device, such as its name or index. You can select a device for a Context by passing the entry to its constructor.

        You can optionally pass one or more property values to this method, in which case they act as filters. Devices are only returned if they are compatible with the specified values. For example, some Platforms offer a choice of precision modes, but not all devices support all precision modes. If you specify double precision, only devices that support double precision will be returned.

        Some Platforms do not offer a choice of devices. In those cases, this method returns a single entry that contains no properties.
        """
        return _openmm.Platform_getDevices(self, *args)
...
class PythonForce(Force):
    ...
    * </verbatim>
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _openmm.delete_PythonForce

    def getGlobalParameters(self):
        r"""
        getGlobalParameters(self) -> mapstringdouble
        ...
        """
        return _openmm.PythonForce_getGlobalParameters(self)

    def getPickledFunction(self):
        r"""
        getPickledFunction(self) -> std::vector< char,std::allocator< char > > const &
        Get the pickled representation of the computation function. If it cannot be pickled, this will be an empty vector.
        """
        return _openmm.PythonForce_getPickledFunction(self)
    ...
    def usesPeriodicBoundaryConditions(self):
        ...
        bool
            true if force uses PBC and false otherwise
        """
        return _openmm.PythonForce_usesPeriodicBoundaryConditions(self)
    ...
    def setUsesPeriodicBoundaryConditions(self, periodic):
        ...
        """
        return _openmm.PythonForce_setUsesPeriodicBoundaryConditions(self, periodic)
    ...
    def __init__(self, *args):
        ...
        """
        _openmm.PythonForce_swiginit(self, _openmm.new_PythonForce(*args))

# Register PythonForce in _openmm:
_openmm.PythonForce_swigregister(PythonForce)
